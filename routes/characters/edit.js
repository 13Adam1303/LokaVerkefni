...
router.post("/edit/:id", (req, res) => {
  ...
  try {
    const query = `
      ...
      SET name = ?, "class" = ?, level = ?, max_hp = ?, current_hp = ?, temporary_hp = ?, dying = ?, wounded = ?, resistances = ?, conditions = ?, 
          base_ac = ?, dexterity_modifier = ?, ac_cap = ?, ac_proficiency = ?, unarmored_bonus = ?, light_armor_bonus = ?, medium_armor_bonus = ?, 
          heavy_armor_bonus = ?, ac_item_bonus = ?, shield_bonus = ?, shield_hardness = ?, shield_max_hp = ?, shield_current_hp = ?, shield_bt = ?, 
          fortitude_con_modifier = ?, fortitude_proficiency = ?, fortitude_item_bonus = ?, fortitude_other_modifier = ?, reflex_dex_modifier = ?, 
          reflex_proficiency = ?, reflex_item_bonus = ?, reflex_other_modifier = ?, will_wis_modifier = ?, will_proficiency = ?, will_item_bonus = ?, 
          will_other_modifier = ?, notes = ?, languages = ?, 
          senses = ?,
          ancestry = ?,
          heritage = ?,
          size = ?,
    ...
    console.error("Error during character update:", err.message);
